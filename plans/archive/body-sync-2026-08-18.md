...
> 关联:[`part-switch-sync-2026-08-18.md`](part-switch-sync-2026-08-18.md)(部件开关 + P3 控制输入,转轴的输入驱动在此);[`multi-craft-sync-2026-08-16.md`](../multi-craft-sync-2026-08-16.md)(多船生命周期,分离/对接后 body 数量变化归那边);[`latency-smoothing-2026-08-22.md`](latency-smoothing-2026-08-22.md) §9.4(body 位姿的每帧平滑、数量变化重对齐在平滑层实现)
...
- **multi-craft 同步** = **多艘船之间**的身份/生命周期/对接/分离/残骸/切换。见 [`multi-craft-sync-2026-08-16.md`](../multi-craft-sync-2026-08-16.md)。
